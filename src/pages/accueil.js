...
const Accueil=()=>{
    ...
    return(
        ...
        <div className="  w-full  h-full ralative flex items-center relative justify-center">
            <div className="absolute onCommence top-1/2 left-1/2 transform -translate-x-1/2 max-sm:w-full -translate-y-1/2 text-center " >
                <h2>Bienvenue</h2>
...
<div className="imgNav max-xl:h-11/12  flex shadow-2xl w-full h-full ">
            ...
            <div className="max-xl:h-11/12   absolute imgNav w-full  h-full flex">
              <i id="cloud1" className="cloud protest-strike-regular">
                <h1 className="">JAVASCRIPT</h1>
              </i>
