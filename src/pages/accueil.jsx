  ...
  return (
    <>
      <Helmet>
        ...
        <meta
          name="description"
          content="Bienvenue sur la page d'accueil de mon portfolio de développeur web: intégrateur web freelance."
        />
        <meta name="keywords" 
    ...
    `}
      ...
      <div className="  w-full  h-full ralative  flex items-center relative justify-center">
        ...
        <div className=" w-full xl:p-20 h-full flex  justify-center items-center  ">
          <div className="absolute top-20 right-20 max-md:hidden  rounded-3xl max-sm:right-40 max-sm:top-20 ">
            <div className="relative shadow-cyan-500 shadow-2xl">
              <img
                className="h-36 opacity-40"
                src="./images/accueil/tv.webp"
                alt="tv"
              />
