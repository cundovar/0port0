...
const Presentation=()=>{
    ...
    return(
        <div className="  w-full h-full overflow-hidden max-md:pb-52 max-md:pt-10 lg:pb-48 overflow-y-scroll"> 
        <div className=" xl:pt-10 xl:mt-10 space-y-10 max-md:p-2   2xl:mr-20 2xl:mb-10 ">
